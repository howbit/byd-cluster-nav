...
以下为 v2.9.8 在 Android 模拟器上的界面截图。模拟器未连接车机，图中的“未连接”“未检测”仅表示截图环境的状态。

首次配置向导：

![ClusterNav 首次配置向导界面](docs/screenshots/setup-wizard.png)

仪表导航：

![ClusterNav 仪表导航界面](docs/screenshots/navigation.png)
